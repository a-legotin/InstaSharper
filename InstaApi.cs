...
namespace InstaSharper.API
{
    internal class InstaApi : IInstaApi
    {
        ...
        ///     Edit profile
        /// </summary>
        /// <param name="gender">gender, 1 = male, 2 = female, 3 = unknown.</param>
        /// <param name="biography">The biography.</param>
        /// <param name="first_name">The name of the user.</param>
        /// <param name="external_url">Website under the biography.</param>
        /// <param name="email">Email of the profile. Required.</param>
        /// <param name="phone">Phone number.</param>
        /// <param name="username">Username of the profile. Required</param>
        /// <returns>
        ///     Returns true if the profile has been edited
        /// </returns>
        public async Task<IResult<bool>> EditProfileAsync(int gender, string biography, string first_name,
            string external_url, string email, string phone, string username)
        {
            ValidateUser();
            ValidateLoggedIn();
            return await _profileProcessor.EditProfileAsync(gender, biography, first_name, external_url, email, phone, username);
        }
