...
namespace InstaSharper.Abstractions.Models.User
{
    ...
    public class InstaUserShort
    {
        ...
        public static InstaUserShort Empty => new InstaUserShort
        {
        ...
        public override bool Equals(object obj) => Equals(obj as InstaUserShort);

        public override int GetHashCode() => Pk.GetHashCode();
    }
}