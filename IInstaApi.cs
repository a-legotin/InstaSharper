...
namespace InstaSharper.API
{
    public interface IInstaApi
    {
        ...
        /// <param name="username">Username of the profile. Required; either fill in the old username or a new one, don't leave blank.</param>
        /// <returns></returns>
        Task<IResult<bool>> EditProfileAsync(int gender, string biography, string first_name, string external_url, 
