    ...
    : Asn1Object
{
    ...
    public string TimeString
    {
        get
        {
            ...
            {
                if (time.Length == 11) return time.Substring(0, 10) + "00GMT+00:00";

                return time.Substring(0, 12) + "GMT+00:00";
            }

            var index = time.IndexOf('-');
            if (index < 0) index = time.IndexOf('+');

            var d = time;

            if (index == time.Length - 3) d += "00";

            if (index == 10) return d.Substring(0, 10) + "00GMT" + d.Substring(10, 3) + ":" + d.Substring(13, 2);
    ...
    public static DerUtcTime GetInstance(
        object obj)
    {
        if (obj == null || obj is DerUtcTime) return (DerUtcTime)obj;
        ...
        bool isExplicit)
    {
        ...
        if (isExplicit || o is DerUtcTime) return GetInstance(o);
