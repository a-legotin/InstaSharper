    ...
    : DerStringBase
{
    ...
    {
        if (obj == null || obj is DerVideotexString) return (DerVideotexString)obj;
     ...
     * @return a DERVideotexString instance, or null.
     */
    public static DerVideotexString GetInstance(Asn1TaggedObject obj,
                                                bool isExplicit)
    {
        var o = obj.GetObject();

        if (isExplicit || o is DerVideotexString) return GetInstance(o);
    ...
    {
        var other = asn1Object as DerVideotexString;
