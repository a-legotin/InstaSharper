...
namespace InstaSharper.Utils.Encryption.Engine
{
    internal abstract class PkcsObjectIdentifiers
    {
        ...
        public static readonly DerObjectIdentifier Pkcs9AtExtendedCertificateAttributes =
            new DerObjectIdentifier(Pkcs9 + ".9");
        ...
        public static readonly DerObjectIdentifier IdSmime                              =
            new DerObjectIdentifier(Pkcs9 + ".16");
        ...
        public static readonly DerObjectIdentifier
            IdAAContentHint = new DerObjectIdentifier(IdAA + ".4"); // See RFC 2634
        ...
        */
        ...
        public static readonly DerObjectIdentifier
            IdAAContentIdentifier = new DerObjectIdentifier(IdAA + ".7"); // See RFC 2634
        ...
        public static readonly DerObjectIdentifier
            PbeWithShaAnd128BitRC4 = new DerObjectIdentifier(Pkcs12PbeIds + ".1");
