    ...
    : Asn1Object
{
     ...
     * <code>null</code>
     * if not set.
     * @param indirectReference The indirect reference or
     * <code>null</code>
     * if not set.
     * @param dataValueDescriptor The data value descriptor or
     * <code>null</code>
     * if not set.
    ...
    protected override int Asn1GetHashCode()
    {
        ...
        if (DirectReference != null) ret ^= DirectReference.GetHashCode();

        if (IndirectReference != null) ret ^= IndirectReference.GetHashCode();

        if (DataValueDescriptor != null) ret ^= DataValueDescriptor.GetHashCode();
    ...
    private static Asn1Object GetObjFromVector(Asn1EncodableVector v,
                                               int index)
    {
        if (v.Count <= index)
    ...
    private static void WriteEncodable(MemoryStream ms,
                                       Asn1Encodable e)
    {
        if (e != null)
        {
