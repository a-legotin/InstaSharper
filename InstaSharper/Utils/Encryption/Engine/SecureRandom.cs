    ...
    : Random
{
    ...
    private static SecureRandom Master { get; } = new(new CryptoApiRandomGenerator());
#endif

    private static DigestRandomGenerator CreatePrng(string digestName,
                                                    bool autoSeed)
    {
    ...
    public static byte[] GetNextBytes(SecureRandom secureRandom,
                                      int length)
    {
                                           ...
                                           bool autoSeed)
    {
        ...
        if (Platform.EndsWith(upper, "PRNG"))
        {
            ...
            if (prng != null) return new SecureRandom(prng);
        }
