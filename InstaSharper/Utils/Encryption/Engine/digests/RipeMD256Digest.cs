...
namespace InstaSharper.Utils.Encryption.Engine.digests
{
        ...
        : GeneralDigest
    {
        ...
        */
        ...
        private int F2(int a, int b, int c, int d, int x, int s) => RL(a + F2(b, c, d) + x + 0x5a827999, s);

        private int F3(int a, int b, int c, int d, int x, int s) => RL(a + F3(b, c, d) + x + 0x6ed9eba1, s);

        private int F4(int a, int b, int c, int d, int x, int s) =>
            RL(a + F4(b, c, d) + x + unchecked((int) 0x8f1bbcdc), s);

        private int FF1(int a, int b, int c, int d, int x, int s) => RL(a + F1(b, c, d) + x, s);

        private int FF2(int a, int b, int c, int d, int x, int s) => RL(a + F2(b, c, d) + x + 0x6d703ef3, s);

        private int FF3(int a, int b, int c, int d, int x, int s) => RL(a + F3(b, c, d) + x + 0x5c4dd124, s);

        private int FF4(int a, int b, int c, int d, int x, int s) => RL(a + F4(b, c, d) + x + 0x50a28be6, s);
