...
namespace InstaSharper.Utils.Encryption.Engine.digests
{
        ...
        : IMemoable
    {
        ...
        private static int VariantIdentifier(int blockSizeBytes, int outputSizeBytes) =>
            (outputSizeBytes << 16) | blockSizeBytes;
        ...
        private void CreateInitialState()
        {
            ...
            else
            {
                ...
                if (keyVal != null)
                {
                    UbiComplete(SkeinParameters.PARAM_TYPE_KEY, keyVal);
                }
        ...
        {
            CheckInitialised();
            if (outBytes.Length < (outOff + OutputSize))
            {
                throw new Exception("Output buffer is too short to hold output");
            }
        ...
        private class UbiTweak
        {
            ...
            public ulong[] GetWords() => ubiTweak;

            public override string ToString() => Type + " first: " + First + ", final: " + Final;
        }
