    ...
    : IDigest, IMemoable
{
    ...
    private readonly int MyByteLength = 128;
    ...
    public virtual void Reset()
    {
        ...
        xBufOff = 0;
        for (var i = 0; i < xBuf.Length; i++) xBuf[i] = 0;
    ...
    internal void ProcessBlock()
    {
        ...
        //
        for (var ti = 16; ti <= 79; ++ti) W[ti] = Sigma1(W[ti - 2]) + W[ti - 7] + Sigma0(W[ti - 15]) + W[ti - 16];
    ...
    private static ulong Ch(ulong x,
                            ulong y,
                            ulong z)
    {
        return (x & y) ^ (~x & z);
    ...
    private static ulong Maj(ulong x,
                             ulong y,
                             ulong z)
    {
        return (x & y) ^ (x & z) ^ (y & z);
