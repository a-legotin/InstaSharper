    ...
    : IDigest, IMemoable
{
    ...
    */
    ...
    {
        0x02AAB17CF7E90C5EL /*    0 */, unchecked((long)0xAC424B03E243A8ECL) /*    1 */,
        0x72CD5BE30DD5FCD3L /*    2 */, 0x6D019B93F6F97F3AL /*    3 */,
        unchecked((long)0xCD9978FFD21F9193L) /*    4 */, 0x7573A1C9708029E2L /*    5 */,
        unchecked((long)0xB164326B922A83C3L) /*    6 */, 0x46883EEE04915870L /*    7 */,
        unchecked((long)0xEAACE3057103ECE6L) /*    8 */, unchecked((long)0xC54169B808A3535CL) /*    9 */,
        0x4CE754918DDEC47CL /*   10 */, 0x0AA2F4DFDC0DF40CL /*   11 */,
        0x10B76F18A74DBEFAL /*   12 */, unchecked((long)0xC6CCB6235AD1AB6AL) /*   13 */,
        0x13726121572FE2FFL /*   14 */, 0x1A488C6F199D921EL /*   15 */,
        0x4BC9F9F4DA0007CAL /*   16 */, 0x26F5E6F6E85241C7L /*   17 */,
        unchecked((long)0x859079DBEA5947B6L) /*   18 */, 0x4F1885C5C99E8C92L /*   19 */,
        unchecked((long)0xD78E761EA96F864BL) /*   20 */, unchecked((long)0x8E36428C52B5C17DL) /*   21 */,
        0x69CF6827373063C1L /*   22 */, unchecked((long)0xB607C93D9BB4C56EL) /*   23 */,
        0x7D820E760E76B5EAL /*   24 */, 0x645C9CC6F07FDC42L /*   25 */,
        unchecked((long)0xBF38A078243342E0L) /*   26 */, 0x5F6B343C9D2E7D04L /*   27 */,
        unchecked((long)0xF2C28AEB600B0EC6L) /*   28 */, 0x6C0ED85F7254BCACL /*   29 */,
        ...
        0x6AB30A9774424A35L /*   40 */, unchecked((long)0xF4E92F02E325249BL) /*   41 */,
        0x7739DB07061CCAE1L /*   42 */, unchecked((long)0xD8F3B49CECA42A05L) /*   43 */,
        unchecked((long)0xBD56BE3F51382F73L) /*   44 */, 0x45FAED5843B0BB28L /*   45 */,
        0x1C813D5C11BF1F83L /*   46 */, unchecked((long)0x8AF0E4B6D75FA169L) /*   47 */,
        0x33EE18A487AD9999L /*   48 */, 0x3C26E8EAB1C94410L /*   49 */,
        unchecked((long)0xB510102BC0A822F9L) /*   50 */, 0x141EEF310CE6123BL /*   51 */,
        ...
        0x1105586D9C867C84L /*   66 */, unchecked((long)0xDCFFEE85FDA22853L) /*   67 */,
        ...
        unchecked((long)0xDE6C23C44B053D02L) /*   80 */, 0x581C49FED002D64DL /*   81 */,
        unchecked((long)0xDD474D6338261571L) /*   82 */, unchecked((long)0xAA4546C3E473D062L) /*   83 */,
        unchecked((long)0x928FCE349455F860L) /*   84 */, 0x48161BBACAAB94D9L /*   85 */,
        0x63912430770E6F68L /*   86 */, 0x6EC8A5E602C6641CL /*   87 */,
        unchecked((long)0x87282515337DDD2BL) /*   88 */, 0x2CDA6B42034B701BL /*   89 */,
        unchecked((long)0xB03D37C181CB096DL) /*   90 */, unchecked((long)0xE108438266C71C6FL) /*   91 */,
        0x2B3180C7EB51B255L /*   92 */, unchecked((long)0xDF92B82F96C08BBCL) /*   93 */,
        0x5C68C8C0A632F3BAL /*   94 */, 0x5504CC861C3D0556L /*   95 */,
        unchecked((long)0xABBFA4E55FB26B8FL) /*   96 */, 0x41848B0AB3BACEB4L /*   97 */,
        ...
        0x2019295B3E109B33L /*  104 */, unchecked((long)0xF8A9478B73A054CCL) /*  105 */,
        ...
        0x0BD7BA3EBB5DC726L /*  124 */, unchecked((long)0xE54BCA55B86ADB39L) /*  125 */,
        0x1D7A3AFD6C478063L /*  126 */, 0x519EC608E7669EDDL /*  127 */,
        0x0E5715A2D149AA23L /*  128 */, 0x177D4571848FF194L /*  129 */,
        unchecked((long)0xEEB55F3241014C22L) /*  130 */, 0x0F5E5CA13A6E2EC2L /*  131 */,
        ...
        unchecked((long)0xC2E8BCBEBA973BC5L) /*  140 */, 0x000001BCE509745FL /*  141 */,
        0x423777BBE6DAB3D6L /*  142 */, unchecked((long)0xD1661C7EAEF06EB5L) /*  143 */,
        unchecked((long)0xA1781F354DAACFD8L) /*  144 */, 0x2D11284A2B16AFFCL /*  145 */,
        unchecked((long)0xF1FC4F67FA891D1FL) /*  146 */, 0x73ECC25DCB920ADAL /*  147 */,
        unchecked((long)0xAE610C22C2A12651L) /*  148 */, unchecked((long)0x96E0A810D356B78AL) /*  149 */,
        0x5A9A381F2FE7870FL /*  150 */, unchecked((long)0xD5AD62EDE94E5530L) /*  151 */,
        unchecked((long)0xD225E5E8368D1427L) /*  152 */, 0x65977B70C7AF4631L /*  153 */,
        unchecked((long)0x99F889B2DE39D74FL) /*  154 */, 0x233F30BF54E1D143L /*  155 */,
        unchecked((long)0x9A9675D3D9A63C97L) /*  156 */, 0x5470554FF334F9A8L /*  157 */,
        0x166ACB744A4F5688L /*  158 */, 0x70C74CAAB2E4AEADL /*  159 */,
        unchecked((long)0xF0D091646F294D12L) /*  160 */, 0x57B82A89684031D1L /*  161 */,
        unchecked((long)0xEFD95A5A61BE0B6BL) /*  162 */, 0x2FBD12E969F2F29AL /*  163 */,
        unchecked((long)0x9BD37013FEFF9FE8L) /*  164 */, 0x3F9B0404D6085A06L /*  165 */,
        ...
        0x3417F8A68ED3B63FL /*  170 */, unchecked((long)0xB80959295B215B40L) /*  171 */,
        unchecked((long)0xF99CDAEF3B8C8572L) /*  172 */, 0x018C0614F8FCB95DL /*  173 */,
        0x1B14ACCD1A3ACDF3L /*  174 */, unchecked((long)0x84D471F200BB732DL) /*  175 */,
        unchecked((long)0xC1A3110E95E8DA16L) /*  176 */, 0x430A7220BF1A82B8L /*  177 */,
        unchecked((long)0xB77E090D39DF210EL) /*  178 */, 0x5EF4BD9F3CD05E9DL /*  179 */,
        ...
        unchecked((long)0xE9214E7F22D8B4DFL) /*  192 */, 0x2ADDBF532EAC95F4L /*  193 */,
        0x32AE3909B4BD0109L /*  194 */, unchecked((long)0x834DF537B08E3450L) /*  195 */,
        ...
        0x21D87F0135CA1385L /*  200 */, unchecked((long)0xCEBB400F137B8AA5L) /*  201 */,
        0x272E2B66580796BEL /*  202 */, 0x3612264125C2B0DEL /*  203 */,
        0x057702BDAD1EFBB2L /*  204 */, unchecked((long)0xD4BABB8EACF84BE9L) /*  205 */,
        unchecked((long)0x91583139641BC67BL) /*  206 */, unchecked((long)0x8BDC2DE08036E024L) /*  207 */,
        0x603C8156F49F68EDL /*  208 */, unchecked((long)0xF7D236F7DBEF5111L) /*  209 */,
        ...
        unchecked((long)0x8C505077794A81B9L) /*  216 */, 0x3ACAAF8F056338F0L /*  217 */,
        0x07B43F50627A6778L /*  218 */, 0x4A44AB49F5ECCC77L /*  219 */,
        0x3BC3D6E4B679EE98L /*  220 */, unchecked((long)0x9CC0D4D1CF14108CL) /*  221 */,
        0x4406C00B206BC8A0L /*  222 */, unchecked((long)0x82A18854C8D72D89L) /*  223 */,
        0x67E366B35C3C432CL /*  224 */, unchecked((long)0xB923DD61102B37F2L) /*  225 */,
        0x56AB2779D884271DL /*  226 */, unchecked((long)0xBE83E1B0FF1525AFL) /*  227 */,
        unchecked((long)0xFB7C65D4217E49A9L) /*  228 */, 0x6BDBE0E76D48E7D4L /*  229 */,
        0x08DF828745D9179EL /*  230 */, 0x22EA6A9ADD53BD34L /*  231 */,
        unchecked((long)0xE36E141C5622200AL) /*  232 */, 0x7F805D1B8CB750EEL /*  233 */,
        ...
        unchecked((long)0xBB434A2DEE7269E7L) /*  240 */, 0x78CB67ECF931FA38L /*  241 */,
        unchecked((long)0xF33B0372323BBF9CL) /*  242 */, 0x52D66336FB279C74L /*  243 */,
        0x505F33AC0AFB4EAAL /*  244 */, unchecked((long)0xE8A5CD99A2CCE187L) /*  245 */,
        0x534974801E2D30BBL /*  246 */, unchecked((long)0x8D2D5711D5876D90L) /*  247 */,
        0x1F1A412891BC038EL /*  248 */, unchecked((long)0xD6E2E71D82E56648L) /*  249 */,
        0x74036C3A497732B7L /*  250 */, unchecked((long)0x89B67ED96361F5ABL) /*  251 */,
    ...
    private static readonly long[] t2 =
    {
        ...
        unchecked((long)0xD932ADDBC9B79434L) /*  260 */, 0x08EA70E42015AFF5L /*  261 */,
        ...
        unchecked((long)0xCD45505E8353E80DL) /*  272 */, 0x18D19A00D4DB0717L /*  273 */,
        0x34A0CFEDA5F38101L /*  274 */, 0x0BE77E518887CAF2L /*  275 */,
        0x1E341438B3C45136L /*  276 */, unchecked((long)0xE05797F49089CCF9L) /*  277 */,
        unchecked((long)0xFFD23F9DF2591D14L) /*  278 */, 0x543DDA228595C5CDL /*  279 */,
        0x661F81FD99052A33L /*  280 */, unchecked((long)0x8736E641DB0F7B76L) /*  281 */,
        0x15227725418E5307L /*  282 */, unchecked((long)0xE25F7F46162EB2FAL) /*  283 */,
        0x48A8B2126C13D9FEL /*  284 */, unchecked((long)0xAFDC541792E76EEAL) /*  285 */,
        0x03D912BFC6D1898FL /*  286 */, 0x31B1AAFA1B83F51BL /*  287 */,
        unchecked((long)0xF1AC2796E42AB7D9L) /*  288 */, 0x40A3A7D7FCD2EBACL /*  289 */,
        ...
        unchecked((long)0xF6DD59FF62FE932BL) /*  298 */, 0x3537354511A8AC7DL /*  299 */,
        unchecked((long)0xCA845E9172FADCD4L) /*  300 */, unchecked((long)0x84F82B60329D20DCL) /*  301 */,
        0x79C62CE1CD672F18L /*  302 */, unchecked((long)0x8B09A2ADD124642CL) /*  303 */,
        unchecked((long)0xD0C1E96A19D9E726L) /*  304 */, 0x5A786A9B4BA9500CL /*  305 */,
        0x0E020336634C43F3L /*  306 */, unchecked((long)0xC17B474AEB66D822L) /*  307 */,
        0x6A731AE3EC9BAAC2L /*  308 */, unchecked((long)0x8226667AE0840258L) /*  309 */,
        0x67D4567691CAECA5L /*  310 */, 0x1D94155C4875ADB5L /*  311 */,
        0x6D00FD985B813FDFL /*  312 */, 0x51286EFCB774CD06L /*  313 */,
        0x5E8834471FA744AFL /*  314 */, unchecked((long)0xF72CA0AEE761AE2EL) /*  315 */,
        ...
        0x4631D816F5EF30A7L /*  320 */, unchecked((long)0xB880B5B51504A6BEL) /*  321 */,
        0x641793C37ED84B6CL /*  322 */, 0x7B21ED77F6E97D96L /*  323 */,
        0x776306312EF96B73L /*  324 */, unchecked((long)0xAE528948E86FF3F4L) /*  325 */,
        ...
        unchecked((long)0xE359E7EA77DCB1D7L) /*  332 */, 0x526C0773749ABE6EL /*  333 */,
        0x735AE5F9D09F734BL /*  334 */, 0x493FC7CC8A558BA8L /*  335 */,
        unchecked((long)0xB0B9C1533041AB45L) /*  336 */, 0x321958BA470A59BDL /*  337 */,
        unchecked((long)0x852DB00B5F46C393L) /*  338 */, unchecked((long)0x91209B2BD336B0E5L) /*  339 */,
        0x6E604F7D659EF19FL /*  340 */, unchecked((long)0xB99A8AE2782CCB24L) /*  341 */,
        unchecked((long)0xCCF52AB6C814C4C7L) /*  342 */, 0x4727D9AFBE11727BL /*  343 */,
        0x7E950D0C0121B34DL /*  344 */, 0x756F435670AD471FL /*  345 */,
        unchecked((long)0xF5ADD442615A6849L) /*  346 */, 0x4E87E09980B9957AL /*  347 */,
        0x2ACFA1DF50AEE355L /*  348 */, unchecked((long)0xD898263AFD2FD556L) /*  349 */,
        ...
        unchecked((long)0xB1BD6F1B4D502843L) /*  358 */, 0x1C761BA38FFF4012L /*  359 */,
        0x0D1530C4E2E21F3BL /*  360 */, unchecked((long)0x8943CE69A7372C8AL) /*  361 */,
        unchecked((long)0xE5184E11FEB5CE66L) /*  362 */, 0x618BDB80BD736621L /*  363 */,
        0x7D29BAD68B574D0BL /*  364 */, unchecked((long)0x81BB613E25E6FE5BL) /*  365 */,
        0x071C9C10BC07913FL /*  366 */, unchecked((long)0xC7BEEB7909AC2D97L) /*  367 */,
        ...
        0x3F6AB7D500090FB4L /*  374 */, unchecked((long)0x9CC0F2A057268AC0L) /*  375 */,
        0x3DEE9D2DEDBF42D1L /*  376 */, 0x330F49C87960A972L /*  377 */,
        unchecked((long)0xC6B2720287421B41L) /*  378 */, 0x0AC59EC07C00369CL /*  379 */,
        unchecked((long)0xEF4EAC49CB353425L) /*  380 */, unchecked((long)0xF450244EEF0129D8L) /*  381 */,
        unchecked((long)0x8ACC46E5CAF4DEB6L) /*  382 */, 0x2FFEAB63989263F7L /*  383 */,
        unchecked((long)0x8F7CB9FE5D7A4578L) /*  384 */, 0x5BD8F7644E634635L /*  385 */,
        0x427A7315BF2DC900L /*  386 */, 0x17D0C4AA2125261CL /*  387 */,
        0x3992486C93518E50L /*  388 */, unchecked((long)0xB4CBFEE0A2D7D4C3L) /*  389 */,
        0x7C75D6202C5DDD8DL /*  390 */, unchecked((long)0xDBC295D8E35B6C61L) /*  391 */,
        0x60B369D302032B19L /*  392 */, unchecked((long)0xCE42685FDCE44132L) /*  393 */,
        0x06F3DDB9DDF65610L /*  394 */, unchecked((long)0x8EA4D21DB5E148F0L) /*  395 */,
        ...
        0x0C6B18576AAADBC8L /*  400 */, unchecked((long)0xB65DEAA91299FAE3L) /*  401 */,
        unchecked((long)0xFB2B794B7F1027E7L) /*  402 */, 0x04E4317F443B5BEBL /*  403 */,
        0x4B852D325939D0A6L /*  404 */, unchecked((long)0xD5AE6BEEFB207FFCL) /*  405 */,
        0x309682B281C7D374L /*  406 */, unchecked((long)0xBAE309A194C3B475L) /*  407 */,
        unchecked((long)0x8CC3F97B13B49F05L) /*  408 */, unchecked((long)0x98A9422FF8293967L) /*  409 */,
        0x244B16B01076FF7CL /*  410 */, unchecked((long)0xF8BF571C663D67EEL) /*  411 */,
        0x1F0D6758EEE30DA1L /*  412 */, unchecked((long)0xC9B611D97ADEB9B7L) /*  413 */,
        unchecked((long)0xB7AFD5887B6C57A2L) /*  414 */, 0x6290AE846B984FE1L /*  415 */,
        unchecked((long)0x94DF4CDEACC1A5FDL) /*  416 */, 0x058A5BD1C5483AFFL /*  417 */,
        0x63166CC142BA3C37L /*  418 */, unchecked((long)0x8DB8526EB2F76F40L) /*  419 */,
        ...
        unchecked((long)0xE4669F39040201F6L) /*  430 */, 0x7A1D7C218CF04ADEL /*  431 */,
        ...
        0x0239F450274F2228L /*  448 */, unchecked((long)0xBB073AF01D5E868BL) /*  449 */,
        unchecked((long)0xBFC80571C10E96C1L) /*  450 */, unchecked((long)0xD267088568222E23L) /*  451 */,
        unchecked((long)0x9671A3D48E80B5B0L) /*  452 */, 0x55B5D38AE193BB81L /*  453 */,
        0x693AE2D0A18B04B8L /*  454 */, 0x5C48B4ECADD5335FL /*  455 */,
        unchecked((long)0xFD743B194916A1CAL) /*  456 */, 0x2577018134BE98C4L /*  457 */,
        unchecked((long)0xE77987E83C54A4ADL) /*  458 */, 0x28E11014DA33E1B9L /*  459 */,
        ...
        unchecked((long)0xF306558C673AC8B2L) /*  466 */, 0x41F639C6B6C9772AL /*  467 */,
        ...
        unchecked((long)0xF9ABF3CE5A3E2469L) /*  472 */, 0x741E768D0FD312D2L /*  473 */,
        0x0144B883CED652C6L /*  474 */, unchecked((long)0xC20B5A5BA33F8552L) /*  475 */,
        0x1AE69633C3435A9DL /*  476 */, unchecked((long)0x97A28CA4088CFDECL) /*  477 */,
        unchecked((long)0x8824A43C1E96F420L) /*  478 */, 0x37612FA66EEEA746L /*  479 */,
        0x6B4CB165F9CF0E5AL /*  480 */, 0x43AA1C06A0ABFB4AL /*  481 */,
        0x7F4DC26FF162796BL /*  482 */, 0x6CBACC8E54ED9B0FL /*  483 */,
        unchecked((long)0xA6B7FFEFD2BB253EL) /*  484 */, 0x2E25BC95B0A29D4FL /*  485 */,
        unchecked((long)0x86D6A58BDEF1388CL) /*  486 */, unchecked((long)0xDED74AC576B6F054L) /*  487 */,
        unchecked((long)0x8030BDBC2B45805DL) /*  488 */, 0x3C81AF70E94D9289L /*  489 */,
        0x3EFF6DDA9E3100DBL /*  490 */, unchecked((long)0xB38DC39FDFCC8847L) /*  491 */,
        0x123885528D17B87EL /*  492 */, unchecked((long)0xF2DA0ED240B1B642L) /*  493 */,
        ...
        unchecked((long)0xEC6974053638CFE4L) /*  498 */, 0x2BA7B67C0CEC4E4CL /*  499 */,
        unchecked((long)0xAC2F4DF3E5CE32EDL) /*  500 */, unchecked((long)0xCB33D14326EA4C11L) /*  501 */,
        unchecked((long)0xA4E9044CC77E58BCL) /*  502 */, 0x5F513293D934FCEFL /*  503 */,
        0x5DC9645506E55444L /*  504 */, 0x50DE418F317DE40AL /*  505 */,
        0x388CB31A69DDE259L /*  506 */, 0x2DB4A83455820A86L /*  507 */,
        unchecked((long)0x9010A91E84711AE9L) /*  508 */, 0x4DF7F0B7B1498371L /*  509 */,
        unchecked((long)0xD62A2EABC0977179L) /*  510 */, 0x22FAC097AA8D5C0EL /*  511 */
    };

    private static readonly long[] t3 =
    {
        unchecked((long)0xF49FCC2FF1DAF39BL) /*  512 */, 0x487FD5C66FF29281L /*  513 */,
        unchecked((long)0xE8A30667FCDCA83FL) /*  514 */, 0x2C9B4BE3D2FCCE63L /*  515 */,
        unchecked((long)0xDA3FF74B93FBBBC2L) /*  516 */, 0x2FA165D2FE70BA66L /*  517 */,
        ...
        unchecked((long)0x96C6920BE2B2ABC5L) /*  524 */, 0x66AF4163375A9172L /*  525 */,
        0x2174ABDCCA7127FBL /*  526 */, unchecked((long)0xB33CCEA64A72FF41L) /*  527 */,
        ...
        unchecked((long)0x9B50F8850FD58892L) /*  534 */, 0x4975488358B74DE8L /*  535 */,
        unchecked((long)0xA3354FF691531C61L) /*  536 */, 0x0702BBE481D2C6EEL /*  537 */,
        unchecked((long)0x89FB24057DEDED98L) /*  538 */, unchecked((long)0xAC3075138596E902L) /*  539 */,
        0x1D2D3580172772EDL /*  540 */, unchecked((long)0xEB738FC28E6BC30DL) /*  541 */,
        0x5854EF8F63044326L /*  542 */, unchecked((long)0x9E5C52325ADD3BBEL) /*  543 */,
        ...
        unchecked((long)0xFE9D5D70EFBF79ECL) /*  552 */, 0x5B13B9DD9C481854L /*  553 */,
        ...
        0x3485BEB153677D5DL /*  560 */, unchecked((long)0xDD191D781F8C492AL) /*  561 */,
        unchecked((long)0xF60866BAA784EBF9L) /*  562 */, 0x518F643BA2D08C74L /*  563 */,
        unchecked((long)0x8852E956E1087C22L) /*  564 */, unchecked((long)0xA768CB8DC410AE8DL) /*  565 */,
        0x38047726BFEC8E1AL /*  566 */, unchecked((long)0xA67738B4CD3B45AAL) /*  567 */,
        unchecked((long)0xAD16691CEC0DDE19L) /*  568 */, unchecked((long)0xC6D4319380462E07L) /*  569 */,
        unchecked((long)0xC5A5876D0BA61938L) /*  570 */, 0x16B9FA1FA58FD840L /*  571 */,
        0x188AB1173CA74F18L /*  572 */, unchecked((long)0xABDA2F98C99C021FL) /*  573 */,
        ...
        0x4325A3342CDB396BL /*  586 */, unchecked((long)0x8AE77E62B301B252L) /*  587 */,
        unchecked((long)0xC36F9E9F6655615AL) /*  588 */, unchecked((long)0x85455A2D92D32C09L) /*  589 */,
        unchecked((long)0xF2C7DEA949477485L) /*  590 */, 0x63CFB4C133A39EBAL /*  591 */,
        unchecked((long)0x83B040CC6EBC5462L) /*  592 */, 0x3B9454C8FDB326B0L /*  593 */,
        0x56F56A9E87FFD78CL /*  594 */, 0x2DC2940D99F42BC6L /*  595 */,
        unchecked((long)0x98F7DF096B096E2DL) /*  596 */, 0x19A6E01E3AD852BFL /*  597 */,
        0x42A99CCBDBD4B40BL /*  598 */, unchecked((long)0xA59998AF45E9C559L) /*  599 */,
        ...
        0x331FD92E600B9FCFL /*  610 */, unchecked((long)0xA498F96148EA3AD6L) /*  611 */,
        unchecked((long)0xA8D8426E8B6A83EAL) /*  612 */, unchecked((long)0xA089B274B7735CDCL) /*  613 */,
        unchecked((long)0x87F6B3731E524A11L) /*  614 */, 0x118808E5CBC96749L /*  615 */,
        ...
        0x398071350CAF30C8L /*  630 */, unchecked((long)0xD0A77A89F017687AL) /*  631 */,
        ...
        unchecked((long)0xFA8B0C53DF7CA1D9L) /*  636 */, 0x3FD9DCBC886CCB77L /*  637 */,
        unchecked((long)0xC040917CA91B4720L) /*  638 */, 0x7DD00142F9D1DCDFL /*  639 */,
        unchecked((long)0x8476FC1D4F387B58L) /*  640 */, 0x23F8E7C5F3316503L /*  641 */,
        0x032A2244E7E37339L /*  642 */, 0x5C87A5D750F5A74BL /*  643 */,
        0x082B4CC43698992EL /*  644 */, unchecked((long)0xDF917BECB858F63CL) /*  645 */,
        0x3270B8FC5BF86DDAL /*  646 */, 0x10AE72BB29B5DD76L /*  647 */,
        0x576AC94E7700362BL /*  648 */, 0x1AD112DAC61EFB8FL /*  649 */,
        0x691BC30EC5FAA427L /*  650 */, unchecked((long)0xFF246311CC327143L) /*  651 */,
        ...
        unchecked((long)0xC8FFD13F1BE7E1D2L) /*  656 */, 0x7578AE66004DDBE1L /*  657 */,
        0x05833F01067BE646L /*  658 */, unchecked((long)0xBB34B5AD3BFE586DL) /*  659 */,
        0x095F34C9A12B97F0L /*  660 */, 0x247AB64525D60CA8L /*  661 */,
        unchecked((long)0xDCDBC6F3017477D1L) /*  662 */, 0x4A2E14D4DECAD24DL /*  663 */,
        unchecked((long)0xBDB5E6D9BE0A1EEBL) /*  664 */, 0x2A7E70F7794301ABL /*  665 */,
        unchecked((long)0xDEF42D8A270540FDL) /*  666 */, 0x01078EC0A34C22C1L /*  667 */,
        unchecked((long)0xE5DE511AF4C16387L) /*  668 */, 0x7EBB3A52BD9A330AL /*  669 */,
        ...
        0x28E06C18EA1141E6L /*  674 */, unchecked((long)0xD2B28CBD984F6B28L) /*  675 */,
        0x26B75F6C446E9D83L /*  676 */, unchecked((long)0xBA47568C4D418D7FL) /*  677 */,
        unchecked((long)0xD80BADBFE6183D8EL) /*  678 */, 0x0E206D7F5F166044L /*  679 */,
        unchecked((long)0xE258A43911CBCA3EL) /*  680 */, 0x723A1746B21DC0BCL /*  681 */,
        unchecked((long)0xC7CAA854F5D7CDD3L) /*  682 */, 0x7CAC32883D261D9CL /*  683 */,
        0x7690C26423BA942CL /*  684 */, 0x17E55524478042B8L /*  685 */,
        unchecked((long)0xE0BE477656A2389FL) /*  686 */, 0x4D289B5E67AB2DA0L /*  687 */,
        0x44862B9C8FBBFD31L /*  688 */, unchecked((long)0xB47CC8049D141365L) /*  689 */,
        unchecked((long)0x822C1B362B91C793L) /*  690 */, 0x4EB14655FB13DFD8L /*  691 */,
        0x1ECBBA0714E2A97BL /*  692 */, 0x6143459D5CDE5F14L /*  693 */,
        0x53A8FBF1D5F0AC89L /*  694 */, unchecked((long)0x97EA04D81C5E5B00L) /*  695 */,
        0x622181A8D4FDB3F3L /*  696 */, unchecked((long)0xE9BCD341572A1208L) /*  697 */,
        0x1411258643CCE58AL /*  698 */, unchecked((long)0x9144C5FEA4C6E0A4L) /*  699 */,
        ...
        unchecked((long)0xCAE321FBC819D504L) /*  706 */, 0x129A50B3AC60BFA6L /*  707 */,
        unchecked((long)0xCD5E68EA7E9FB6C3L) /*  708 */, unchecked((long)0xB01C90199483B1C7L) /*  709 */,
        0x3DE93CD5C295376CL /*  710 */, unchecked((long)0xAED52EDF2AB9AD13L) /*  711 */,
        0x2E60F512C0A07884L /*  712 */, unchecked((long)0xBC3D86A3E36210C9L) /*  713 */,
        0x35269D9B163951CEL /*  714 */, 0x0C7D6E2AD0CDB5FAL /*  715 */,
        0x59E86297D87F5733L /*  716 */, 0x298EF221898DB0E7L /*  717 */,
        0x55000029D1A5AA7EL /*  718 */, unchecked((long)0x8BC08AE1B5061B45L) /*  719 */,
        ...
        unchecked((long)0x9CC5C7141D1CD4E3L) /*  726 */, 0x78BD1638218E5534L /*  727 */,
        unchecked((long)0xB2F11568F850246AL) /*  728 */, unchecked((long)0xEDFABCFA9502BC29L) /*  729 */,
        0x796CE5F2DA23051BL /*  730 */, unchecked((long)0xAAE128B0DC93537CL) /*  731 */,
        0x3A493DA0EE4B29AEL /*  732 */, unchecked((long)0xB5DF6B2C416895D7L) /*  733 */,
        unchecked((long)0xFCABBD25122D7F37L) /*  734 */, 0x70810B58105DC4B1L /*  735 */,
        unchecked((long)0xE10FDD37F7882A90L) /*  736 */, 0x524DCAB5518A3F5CL /*  737 */,
        0x3C9E85878451255BL /*  738 */, 0x4029828119BD34E2L /*  739 */,
        0x74A05B6F5D3CECCBL /*  740 */, unchecked((long)0xB610021542E13ECAL) /*  741 */,
        0x0FF979D12F59E2ACL /*  742 */, 0x6037DA27E4F9CC50L /*  743 */,
        0x5E92975A0DF1847DL /*  744 */, unchecked((long)0xD66DE190D3E623FEL) /*  745 */,
        0x5032D6B87B568048L /*  746 */, unchecked((long)0x9A36B7CE8235216EL) /*  747 */,
        ...
        0x730C196946A4B9B2L /*  754 */, unchecked((long)0x81E289AA7F49DA68L) /*  755 */,
        0x64669A0F83B1A05FL /*  756 */, 0x27B3FF7D9644F48BL /*  757 */,
        unchecked((long)0xCC6B615C8DB675B3L) /*  758 */, 0x674F20B9BCEBBE95L /*  759 */,
        ...
        unchecked((long)0xD3DC3BEF265B0F70L) /*  766 */, 0x6D0E60F5C3578A9EL /*  767 */
    };

    private static readonly long[] t4 =
    {
        0x5B0E608526323C55L /*  768 */, 0x1A46C1A9FA1B59F5L /*  769 */,
        unchecked((long)0xA9E245A17C4C8FFAL) /*  770 */, 0x65CA5159DB2955D7L /*  771 */,
        0x05DB0A76CE35AFC2L /*  772 */, unchecked((long)0x81EAC77EA9113D45L) /*  773 */,
        0x528EF88AB6AC0A0DL /*  774 */, unchecked((long)0xA09EA253597BE3FFL) /*  775 */,
        0x430DDFB3AC48CD56L /*  776 */, unchecked((long)0xC4B3A67AF45CE46FL) /*  777 */,
        0x4ECECFD8FBE2D05EL /*  778 */, 0x3EF56F10B39935F0L /*  779 */,
        0x0B22D6829CD619C6L /*  780 */, 0x17FD460A74DF2069L /*  781 */,
        0x6CF8CC8E8510ED40L /*  782 */, unchecked((long)0xD6C824BF3A6ECAA7L) /*  783 */,
        0x61243D581A817049L /*  784 */, 0x048BACB6BBC163A2L /*  785 */,
        unchecked((long)0xD9A38AC27D44CC32L) /*  786 */, 0x7FDDFF5BAAF410ABL /*  787 */,
        ...
        unchecked((long)0xD56966B4361A6685L) /*  794 */, 0x277DA5C31221057DL /*  795 */,
        unchecked((long)0x94D59893A43ACFF7L) /*  796 */, 0x64F0C51CCDC02281L /*  797 */,
        0x3D33BCC4FF6189DBL /*  798 */, unchecked((long)0xE005CB184CE66AF1L) /*  799 */,
        unchecked((long)0xFF5CCD1D1DB99BEAL) /*  800 */, unchecked((long)0xB0B854A7FE42980FL) /*  801 */,
        0x7BD46A6A718D4B9FL /*  802 */, unchecked((long)0xD10FA8CC22A5FD8CL) /*  803 */,
        ...
        unchecked((long)0xC2B00BE2F573417FL) /*  808 */, 0x5C9590452180F877L /*  809 */,
        0x7A6BDDFFF370EB00L /*  810 */, unchecked((long)0xCE509E38D6D9D6A4L) /*  811 */,
        unchecked((long)0xEBEB0F00647FA702L) /*  812 */, 0x1DCC06CF76606F06L /*  813 */,
        ...
        unchecked((long)0xA679B9D9D72BBA20L) /*  818 */, 0x53841C0D912D43A5L /*  819 */,
        0x3B7EAA48BF12A4E8L /*  820 */, 0x781E0E47F22F1DDFL /*  821 */,
        unchecked((long)0xEFF20CE60AB50973L) /*  822 */, 0x20D261D19DFFB742L /*  823 */,
        0x16A12B03062A2E39L /*  824 */, 0x1960EB2239650495L /*  825 */,
        0x251C16FED50EB8B8L /*  826 */, unchecked((long)0x9AC0C330F826016EL) /*  827 */,
        unchecked((long)0xED152665953E7671L) /*  828 */, 0x02D63194A6369570L /*  829 */,
        0x5074F08394B1C987L /*  830 */, 0x70BA598C90B25CE1L /*  831 */,
        0x794A15810B9742F6L /*  832 */, 0x0D5925E9FCAF8C6CL /*  833 */,
        0x3067716CD868744EL /*  834 */, unchecked((long)0x910AB077E8D7731BL) /*  835 */,
        0x6A61BBDB5AC42F61L /*  836 */, unchecked((long)0x93513EFBF0851567L) /*  837 */,
        unchecked((long)0xF494724B9E83E9D5L) /*  838 */, unchecked((long)0xE887E1985C09648DL) /*  839 */,
        0x34B1D3C675370CFDL /*  840 */, unchecked((long)0xDC35E433BC0D255DL) /*  841 */,
        unchecked((long)0xD0AAB84234131BE0L) /*  842 */, 0x08042A50B48B7EAFL /*  843 */,
        ...
        unchecked((long)0x927217402C08C6E5L) /*  848 */, 0x2A8AB754A795D9EEL /*  849 */,
        unchecked((long)0xA442F7552F72943DL) /*  850 */, 0x2C31334E19781208L /*  851 */,
        0x4FA98D7CEAEE6291L /*  852 */, 0x55C3862F665DB309L /*  853 */,
        unchecked((long)0xBD0610175D53B1F3L) /*  854 */, 0x46FE6CB840413F27L /*  855 */,
        0x3FE03792DF0CFA59L /*  856 */, unchecked((long)0xCFE700372EB85E8FL) /*  857 */,
        ...
        0x39412E2877B60728L /*  862 */, unchecked((long)0xA1265EF3AFC9A62CL) /*  863 */,
        unchecked((long)0xBCC2770C6A2506C5L) /*  864 */, 0x3AB66DD5DCE1CE12L /*  865 */,
        unchecked((long)0xE65499D04A675B37L) /*  866 */, 0x7D8F523481BFD216L /*  867 */,
        ...
        0x37E99257E7E061F8L /*  872 */, unchecked((long)0xFA52626904775AAAL) /*  873 */,
        ...
        0x1B432F2CCA1D3348L /*  878 */, unchecked((long)0xDE1D1F8F9F6FA013L) /*  879 */,
        0x606602A047A7DDD6L /*  880 */, unchecked((long)0xD237AB64CC1CB2C7L) /*  881 */,
        ...
        unchecked((long)0x855E3602D2D4E022L) /*  888 */, 0x073805BAD01F784CL /*  889 */,
        0x33E17A133852F546L /*  890 */, unchecked((long)0xDF4874058AC7B638L) /*  891 */,
        unchecked((long)0xBA92B29C678AA14AL) /*  892 */, 0x0CE89FC76CFAADCDL /*  893 */,
        0x5F9D4E0908339E34L /*  894 */, unchecked((long)0xF1AFE9291F5923B9L) /*  895 */,
        0x6E3480F60F4A265FL /*  896 */, unchecked((long)0xEEBF3A2AB29B841CL) /*  897 */,
        unchecked((long)0xE21938A88F91B4ADL) /*  898 */, 0x57DFEFF845C6D3C3L /*  899 */,
        0x2F006B0BF62CAAF2L /*  900 */, 0x62F479EF6F75EE78L /*  901 */,
        0x11A55AD41C8916A9L /*  902 */, unchecked((long)0xF229D29084FED453L) /*  903 */,
        0x42F1C27B16B000E6L /*  904 */, 0x2B1F76749823C074L /*  905 */,
        0x4B76ECA3C2745360L /*  906 */, unchecked((long)0x8C98F463B91691BDL) /*  907 */,
        0x14BCC93CF1ADE66AL /*  908 */, unchecked((long)0x8885213E6D458397L) /*  909 */,
        ...
        0x0A234AA642391484L /*  936 */, unchecked((long)0xF6F9508028F80D9DL) /*  937 */,
        unchecked((long)0xB8E319A27AB3F215L) /*  938 */, 0x31AD9C1151341A4DL /*  939 */,
        ...
        0x4AF6B6D3E2ECE2EBL /*  954 */, unchecked((long)0x9C994DBEC7EA08DEL) /*  955 */,
        0x49ACE597B09A8BC4L /*  956 */, unchecked((long)0xB38C4766CF0797BAL) /*  957 */,
        0x131B9373C57C2A75L /*  958 */, unchecked((long)0xB1822CCE61931E58L) /*  959 */,
        unchecked((long)0x9D7555B909BA1C0CL) /*  960 */, 0x127FAFDD937D11D2L /*  961 */,
        0x29DA3BADC66D92E4L /*  962 */, unchecked((long)0xA2C1D57154C2ECBCL) /*  963 */,
        ...
        0x3249D8F9C80046C9L /*  968 */, unchecked((long)0x80CF9BEDE388FB63L) /*  969 */,
        0x1881539A116CF19EL /*  970 */, 0x5103F3F76BD52457L /*  971 */,
        0x15B7E6F5AE47F7A8L /*  972 */, unchecked((long)0xDBD7C6DED47E9CCFL) /*  973 */,
        0x44E55C410228BB1AL /*  974 */, unchecked((long)0xB647D4255EDB4E99L) /*  975 */,
        0x5D11882BB8AAFC30L /*  976 */, unchecked((long)0xF5098BBB29D3212AL) /*  977 */,
        unchecked((long)0x8FB5EA14E90296B3L) /*  978 */, 0x677B942157DD025AL /*  979 */,
        ...
        0x03F38C96BA582C52L /*  984 */, unchecked((long)0xCAD1BDBD7FD85DB2L) /*  985 */,
        ...
        unchecked((long)0xC02C11AC923C852BL) /*  992 */, 0x2388B1990DF2A87BL /*  993 */,
        0x7C8008FA1B4F37BEL /*  994 */, 0x1F70D0C84D54E503L /*  995 */,
        0x5490ADEC7ECE57D4L /*  996 */, 0x002B3C27D9063A3AL /*  997 */,
        0x7EAEA3848030A2BFL /*  998 */, unchecked((long)0xC602326DED2003C0L) /*  999 */,
        ...
        0x6345A0DC5FBBD519L /* 1012 */, unchecked((long)0x8628FE269B9465CAL) /* 1013 */,
        0x1E5D01603F9C51ECL /* 1014 */, 0x4DE44006A15049B7L /* 1015 */,
        unchecked((long)0xBF6C70E5F776CBB1L) /* 1016 */, 0x411218F2EF552BEDL /* 1017 */,
    ...
    private readonly long[] xVal = new long[8];

    //
    // registers
    //
    private long a, bytes, c;
    private int bOff;
        ...
        byte input)
    {
        ...
        if (bOff == Buffer.Length) ProcessWord(Buffer, 0);
        ...
        int outOff)
    {
        ...
        UnpackWord(bytes, output, outOff + 8);
    ...
    public void Reset()
    {
        ...
        bytes = unchecked((long)0xFEDCBA9876543210L);
        c = unchecked((long)0xF096A5B4C3B2E187L);

        xOff = 0;
        for (var i = 0; i != xVal.Length; i++) xVal[i] = 0;
    ...
    public void Reset(IMemoable other)
    {
        ...
        Array.Copy(t.xVal, 0, xVal, 0, t.xVal.Length);
        xOff = t.xOff;
    ...
    private void ProcessWord(
        ...
        int off)
    {
        xVal[xOff++] = ((long)(b[off + 7] & 0xff) << 56)
        ...
        if (xOff == xVal.Length) ProcessBlock();
        ...
        long mul)
    {
        ...
        bytes += t4[(int)(c >> 8) & 0xff] ^ t3[(int)(c >> 24) & 0xff]
    ...
    {
        a ^= x;
        bytes -= t1[(int)a & 0xff] ^ t2[(int)(a >> 16) & 0xff]
    ...
    {
        bytes ^= x;
        c -= t1[(int)bytes & 0xff] ^ t2[(int)(bytes >> 16) & 0xff]
                                   ^ t3[(int)(bytes >> 32) & 0xff] ^ t4[(int)(bytes >> 48) & 0xff];
        a += t4[(int)(bytes >> 8) & 0xff] ^ t3[(int)(bytes >> 24) & 0xff]
                                          ^ t2[(int)(bytes >> 40) & 0xff] ^ t1[(int)(bytes >> 56) & 0xff];
        a *= mul;
    }

    private void KeySchedule()
    {
        xVal[0] -= xVal[7] ^ unchecked((long)0xA5A5A5A5A5A5A5A5L);
        xVal[1] ^= xVal[0];
        xVal[2] += xVal[1];
        xVal[3] -= xVal[2] ^ (~xVal[1] << 19);
        xVal[4] ^= xVal[3];
        xVal[5] += xVal[4];
        xVal[6] -= xVal[5] ^ (long)((ulong)~xVal[4] >> 23);
        xVal[7] ^= xVal[6];
        xVal[0] += xVal[7];
        xVal[1] -= xVal[0] ^ (~xVal[7] << 19);
        xVal[2] ^= xVal[1];
        xVal[3] += xVal[2];
        xVal[4] -= xVal[3] ^ (long)((ulong)~xVal[2] >> 23);
        xVal[5] ^= xVal[4];
        xVal[6] += xVal[5];
        xVal[7] -= xVal[6] ^ 0x0123456789ABCDEFL;
    }
