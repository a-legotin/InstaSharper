...
using InstaSharper.Utils.Encryption.Engine.digests;
...
//			algorithms[TeleTrusTObjectIdentifiers.RipeMD320.Id] = "RIPEMD320";
        ...
        internal static DerObjectIdentifier GetObjectIdentifier(
            string mechanism)
        {
            if (mechanism == null)
        ...
        internal static IDigest GetDigest(
            ...
            string algorithm)
        {
            ...
            throw new Exception("Digest " + mechanism + " not recognised.");
        }
        ...
        internal static byte[] CalculateDigest(DerObjectIdentifier id, byte[] input) => CalculateDigest(id.Id, input);
