...
internal abstract class Nat
{
    ...
    public static uint Add(int len,
                           uint[] x,
                           uint[] y,
                           uint[] z)
    {
    ...
    public static uint Add33At(int len,
                               uint x,
                               uint[] z,
                               int zPos)
    {
    ...
    public static uint Add33To(int len,
                               uint x,
                               uint[] z)
    {
        var c = (ulong)z[0] + x;
    ...
    public static uint AddBothTo(int len,
                                 uint[] x,
                                 uint[] y,
                                 uint[] z)
    {
    ...
    public static uint AddDWordAt(int len,
                                  ulong x,
                                  uint[] z,
                                  int zPos)
    {
    ...
    public static uint AddDWordTo(int len,
                                  ulong x,
                                  uint[] z)
    {
        var c = z[0] + (x & M);
    ...
    public static uint AddTo(int len,
                             uint[] x,
                             uint[] z)
    {
        ulong c = 0;
    ...
    public static uint AddToEachOther(int len,
                                      uint[] u,
                                      int uOff,
                                      uint[] v,
                                      int vOff)
    ...
    public static uint AddWordAt(int len,
                                 uint x,
                                 uint[] z,
                                 int zPos)
    {
    ...
    public static uint AddWordTo(int len,
                                 uint x,
                                 uint[] z)
    {
        var c = (ulong)x + z[0];
    ...
    public static uint CAdd(int len,
                            int mask,
                            uint[] x,
                            uint[] y,
                            uint[] z)
    ...
    public static uint[] Copy(int len,
                              uint[] x)
    {
        var z = new uint[len];
        Array.Copy(x, 0, z, 0, len);
    ...
    public static ulong[] Copy64(int len,
                                 ulong[] x)
    {
        var z = new ulong[len];
        Array.Copy(x, 0, z, 0, len);
    ...
    public static uint EqualTo(int len,
                               uint[] x,
                               uint y)
    {
        var d = x[0] ^ y;
    ...
    public static uint EqualToZero(int len,
                                   uint[] x)
    {
        uint d = 0;
    ...
    public static uint[] FromBigInteger(int bits,
                                        BigInteger x)
    {
        if (bits < 1)
    ...
    public static ulong[] FromBigInteger64(int bits,
                                           BigInteger x)
    {
        if (bits < 1)
            throw new ArgumentException();
    ...
    public static uint GetBit(uint[] x,
                              int bit)
    {
    ...
    public static bool Gte(int len,
                           uint[] x,
                           uint[] y)
    {
        for (var i = len - 1; i >= 0; --i)
    ...
    public static uint Inc(int len,
                           uint[] z)
    {
        for (var i = 0; i < len; ++i)
    ...
    public static uint IncAt(int len,
                             uint[] z,
                             int zPos)
    {
        Debug.Assert(zPos <= len);
    ...
    public static bool IsOne(int len,
                             uint[] x)
    {
    ...
    public static bool IsZero(int len,
                              uint[] x)
    {
    ...
    public static uint MulAddTo(int len,
                                uint[] x,
                                uint[] y,
                                uint[] zz)
    {
    ...
    public static uint Mul31BothAdd(int len,
                                    uint a,
                                    uint[] x,
                                    uint b,
                                    uint[] y,
    ...
    public static uint MulWord(int len,
                               uint x,
                               uint[] y,
                               uint[] z)
    {
    ...
    public static uint MulWordAddTo(int len,
                                    uint x,
                                    uint[] y,
                                    int yOff,
                                    uint[] z,
    ...
    public static uint MulWordDwordAddAt(int len,
                                         uint x,
                                         ulong y,
                                         uint[] z,
                                         int zPos)
    ...
    public static uint ShiftDownBit(int len,
                                    uint[] z,
                                    uint c)
    {
        var i = len;
    ...
    public static uint ShiftDownBits(int len,
                                     uint[] z,
                                     int bits,
                                     uint c)
    {
    ...
    public static uint ShiftDownWord(int len,
                                     uint[] z,
                                     uint c)
    {
        var i = len;
    ...
    public static uint ShiftUpBit(int len,
                                  uint[] z,
                                  uint c)
    {
        for (var i = 0; i < len; ++i)
    ...
    public static ulong ShiftUpBit64(int len,
                                     ulong[] x,
                                     int xOff,
                                     ulong c,
                                     ulong[] z,
    ...
    public static uint ShiftUpBits(int len,
                                   uint[] z,
                                   int bits,
                                   uint c)
    {
    ...
    public static ulong ShiftUpBits64(int len,
                                      ulong[] z,
                                      int zOff,
                                      int bits,
                                      ulong c)
    ...
    public static uint SquareWordAdd(uint[] x,
                                     int xPos,
                                     uint[] z)
    {
    ...
    public static uint SquareWordAddTo(uint[] x,
                                       int xPos,
                                       uint[] z)
    {
        ulong c = 0, xVal = x[xPos];
    ...
    public static BigInteger ToBigInteger(int len,
                                          uint[] x)
    {
        ...
        {
            var x_i = x[i];
            if (x_i != 0) Pack.UInt32_To_BE(x_i, bs, (len - 1 - i) << 2);
        }
