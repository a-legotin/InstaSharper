...
internal sealed class Pack
{
    ...
    internal static void UInt16_To_BE(ushort n,
                                      byte[] bs)
    {
        bs[0] = (byte)(n >> 8);
        bs[1] = (byte)n;
    ...
    internal static void UInt32_To_BE(uint n,
                                      byte[] bs)
    {
        bs[0] = (byte)(n >> 24);
        bs[1] = (byte)(n >> 16);
    ...
    internal static void UInt32_To_BE(uint[] ns,
                                      byte[] bs,
                                      int off)
    {
    ...
    public static void UInt32_To_BE(uint[] ns,
                                    int nsOff,
                                    int nsLen,
                                    byte[] bs,
                                    int bsOff)
    ...
    internal static void BE_To_UInt32(byte[] bs,
                                      int off,
                                      uint[] ns)
    {
        for (var i = 0; i < ns.Length; ++i)
    ...
    public static void BE_To_UInt32(byte[] bs,
                                    int bsOff,
                                    uint[] ns,
                                    int nsOff,
                                    int nsLen)
    ...
    internal static void UInt64_To_BE(ulong n,
                                      byte[] bs)
    {
    ...
    internal static void UInt64_To_BE(ulong[] ns,
                                      byte[] bs,
                                      int off)
    {
        for (var i = 0; i < ns.Length; ++i)
    ...
    public static void UInt64_To_BE(ulong[] ns,
                                    int nsOff,
                                    int nsLen,
                                    byte[] bs,
                                    int bsOff)
    ...
    internal static void BE_To_UInt64(byte[] bs,
                                      int off,
                                      ulong[] ns)
    {
        for (var i = 0; i < ns.Length; ++i)
    ...
    public static void BE_To_UInt64(byte[] bs,
                                    int bsOff,
                                    ulong[] ns,
                                    int nsOff,
                                    int nsLen)
    ...
    internal static void UInt16_To_LE(ushort n,
                                      byte[] bs)
    {
        bs[0] = (byte)n;
        bs[1] = (byte)(n >> 8);
    ...
    internal static void UInt32_To_LE(uint n,
                                      byte[] bs)
    {
        bs[0] = (byte)n;
        bs[1] = (byte)(n >> 8);
    ...
    internal static void UInt32_To_LE(uint[] ns,
                                      byte[] bs,
                                      int off)
    {
        for (var i = 0; i < ns.Length; ++i)
    ...
    internal static void LE_To_UInt32(byte[] bs,
                                      int off,
                                      uint[] ns)
    {
        for (var i = 0; i < ns.Length; ++i)
    ...
    internal static void UInt64_To_LE(ulong n,
                                      byte[] bs)
    {
    ...
    internal static void UInt64_To_LE(ulong[] ns,
                                      byte[] bs,
                                      int off)
    {
        for (var i = 0; i < ns.Length; ++i)
    ...
    internal static void LE_To_UInt64(byte[] bs,
                                      int off,
                                      ulong[] ns)
    {
        for (var i = 0; i < ns.Length; ++i)
