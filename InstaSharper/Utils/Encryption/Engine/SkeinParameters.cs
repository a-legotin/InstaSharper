...
///             <see cref="SkeinParameters.Builder.SetPublicKey(byte[])">public key</see> with the message digest.
///         </li>
///         <li>
///             A key derivation function, by providing a
///             <see cref="SkeinParameters.Builder.SetKeyIdentifier(byte[])">key identifier</see>.
///         </li>
///         <li>
...
///             <see cref="SkeinParameters.Builder.SetPersonalisation(byte[])">arbitrary</see> personalisation string.
///         </li>
///     </ul>
/// </remarks>
    ...
    : ICipherParameters
{
    ...
    internal class Builder
    {
        ...
        public Builder Set(int type,
                           byte[] value)
        {
            if (value == null) throw new ArgumentException("Parameter value must not be null.");
        ...
        public Builder SetPersonalisation(DateTime date,
                                          string emailAddress,
