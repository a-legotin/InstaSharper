...
namespace InstaSharper.Utils.Encryption.Engine
{
        ...
        : ICipherParameters
    {
        ...
        /// </summary>
        public IDictionary GetParameters() => parameters;
        ...
        {
            private readonly IDictionary parameters = Platform.CreateHashtable();
            ...
            /// </summary>
            public Builder SetKey(byte[] key) => Set(PARAM_TYPE_KEY, key);

            /// <summary>
            /// Sets the <see cref="SkeinParameters.PARAM_TYPE_PERSONALISATION"/> parameter.
            /// </summary>
            public Builder SetPersonalisation(byte[] personalisation) =>
                Set(PARAM_TYPE_PERSONALISATION, personalisation);
            ...
            public Builder SetPersonalisation(DateTime date, string emailAddress, string distinguisher)
            {
                try
                {
                    ...
                    var outBytes = new StreamWriter(bout, System.Text.Encoding.UTF8);
            ...
            /// </summary>
            public Builder SetPublicKey(byte[] publicKey) => Set(PARAM_TYPE_PUBLIC_KEY, publicKey);

            /// <summary>
            /// Sets the <see cref="SkeinParameters.PARAM_TYPE_KEY_IDENTIFIER"/> parameter.
            /// </summary>
            public Builder SetKeyIdentifier(byte[] keyIdentifier) => Set(PARAM_TYPE_KEY_IDENTIFIER, keyIdentifier);

            /// <summary>
            /// Sets the <see cref="SkeinParameters.PARAM_TYPE_NONCE"/> parameter.
            /// </summary>
            public Builder SetNonce(byte[] nonce) => Set(PARAM_TYPE_NONCE, nonce);

            /// <summary>
            /// Constructs a new <see cref="SkeinParameters"/> instance with the parameters provided to this
            /// builder.
            /// </summary>
            public SkeinParameters Build() => new SkeinParameters(parameters);
        }
    }
}