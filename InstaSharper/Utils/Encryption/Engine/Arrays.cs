...
namespace InstaSharper.Utils.Encryption.Engine
{
    ...
    internal abstract class Arrays
    {
        ...
        public static bool[] Clone(bool[] data) => data == null ? null : (bool[]) data.Clone();

        public static byte[] Clone(byte[] data) => data == null ? null : (byte[]) data.Clone();

        public static int[] Clone(int[] data) => data == null ? null : (int[]) data.Clone();

        public static uint[] Clone(uint[] data) => data == null ? null : (uint[]) data.Clone();

        public static long[] Clone(long[] data) => data == null ? null : (long[]) data.Clone();

        public static ulong[] Clone(ulong[] data) => data == null ? null : (ulong[]) data.Clone();
        ...
        public static bool IsNullOrEmpty(byte[] array) => null == array || array.Length < 1;

        public static bool IsNullOrEmpty(object[] array) => null == array || array.Length < 1;
    }
}