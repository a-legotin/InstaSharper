...
internal abstract class MiscObjectIdentifiers
{
    ...
    public static readonly DerObjectIdentifier cast5CBC = new(Entrust + ".66.10");

    //
    // HMAC-SHA1       hMAC-SHA1 OBJECT IDENTIFIER ::= { iso(1) identified-organization(3)
    //       dod(6) internet(1) security(5) mechanisms(5) 8 1 2 }
    //
    public static readonly DerObjectIdentifier HMAC_SHA1 = new("1.3.6.1.5.5.8.1.2");
    ...
    //
    // Scrypt
    public static readonly DerObjectIdentifier id_scrypt = new("1.3.6.1.4.1.11591.4.11");
}