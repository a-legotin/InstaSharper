...
namespace InstaSharper.Utils.Encryption.Engine
{
        ...
        : UnmodifiableDictionary
    {
        ...
        public override bool Contains(object k) => d.Contains(k);
        ...
        public override IDictionaryEnumerator GetEnumerator() => d.GetEnumerator();

        protected override object GetValue(object k) => d[k];
    }
}