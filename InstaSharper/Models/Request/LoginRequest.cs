...
namespace InstaSharper.Models.Request
{
    internal class LoginRequest
    {
        ...
        public static async Task<LoginRequest> Build(IDevice device, IUserCredentials credentials, ILauncherKeysProvider launcherKeysProvider)
        {
            ...
            return new LoginRequest
            {
                ...
                EncPassword = $"#PWD_INSTAGRAM:4:{time}:{EncryptionUtils.EncryptPassword(credentials.Password, publicKey, keyId, time)}"
            };
        }
    }
}